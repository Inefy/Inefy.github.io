...
The movie-night showcase lives at `movie-night.html` and embeds the Zurra3 Twitch stream, the shared IMDb movie list, and a short explanation of the StreamCinema Vote Bot. Build logs live at `notes.html`. The fun corner includes Web Paint, Flappy Workbench, and Snake Lab.
